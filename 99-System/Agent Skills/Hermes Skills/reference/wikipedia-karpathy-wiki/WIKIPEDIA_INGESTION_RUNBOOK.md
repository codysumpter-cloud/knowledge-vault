...
The vault should contain the system for ingesting and summarizing Wikipedia correctly, plus compact derived notes when they are useful.

Raw source dumps should stay outside Git.
