---
type: github-repo
repo: codysumpter-cloud/prismtek-releases
repo_name: prismtek-releases
owner: codysumpter-cloud
visibility: public
default_branch: main
github_url: https://github.com/codysumpter-cloud/prismtek-releases
clone_url: https://github.com/codysumpter-cloud/prismtek-releases.git
status: Needs triage
priority: Triage
...
- GitHub: https://github.com/codysumpter-cloud/prismtek-releases
- Clone: `https://github.com/codysumpter-cloud/prismtek-releases.git`
- Default branch: `main`
- Visibility: `public`
