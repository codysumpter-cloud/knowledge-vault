---
type: github-repo
repo: codysumpter-cloud/buddy-brain
repo_name: buddy-brain
...
> Project memory for `codysumpter-cloud/buddy-brain`. GitHub is the source of truth for source code; this note is the source of truth for project context, decisions, status, and agent handoffs.

## Links

- GitHub: https://github.com/codysumpter-cloud/buddy-brain
- Clone: `https://github.com/codysumpter-cloud/buddy-brain.git`
