---
type: github-repo
repo: codysumpter-cloud/awesome-game-remakes
repo_name: awesome-game-remakes
owner: codysumpter-cloud
visibility: public
default_branch: main
github_url: https://github.com/codysumpter-cloud/awesome-game-remakes
clone_url: https://github.com/codysumpter-cloud/awesome-game-remakes.git
status: Needs triage
priority: Triage
...
- GitHub: https://github.com/codysumpter-cloud/awesome-game-remakes
- Clone: `https://github.com/codysumpter-cloud/awesome-game-remakes.git`
- Default branch: `main`
- Visibility: `public`
