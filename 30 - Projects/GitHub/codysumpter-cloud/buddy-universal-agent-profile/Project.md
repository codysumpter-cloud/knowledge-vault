---
type: github-repo
repo: codysumpter-cloud/buddy-universal-agent-profile
repo_name: buddy-universal-agent-profile
owner: codysumpter-cloud
visibility: public
default_branch: main
github_url: https://github.com/codysumpter-cloud/buddy-universal-agent-profile
clone_url: https://github.com/codysumpter-cloud/buddy-universal-agent-profile.git
status: Needs triage
priority: Triage
...
- GitHub: https://github.com/codysumpter-cloud/buddy-universal-agent-profile
- Clone: `https://github.com/codysumpter-cloud/buddy-universal-agent-profile.git`
- Default branch: `main`
- Visibility: `public`
