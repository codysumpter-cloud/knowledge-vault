---
type: github-repo
repo: codysumpter-cloud/hermes-agent
...
> Project memory for `codysumpter-cloud/hermes-agent`. GitHub is the source of truth for source code; this note is the source of truth for project context, decisions, status, and agent handoffs.

## Links

- GitHub: https://github.com/codysumpter-cloud/hermes-agent
- Clone: `https://github.com/codysumpter-cloud/hermes-agent.git`
- Default branch: `main`
- Visibility: `public`
